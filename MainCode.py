...
####################################################################################################################################################################################################################################################
# The Following codes are not used in this project, I wrote them to find the genarial transformation matrix from each photo to the starting photo when we use sequantial images sequance aiming to use nonlinear trianglation, but I ran out of time
